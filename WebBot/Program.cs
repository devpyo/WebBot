...
namespace WebBot
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"[{result.StatusCode}] {ReadContent(site, result).Substring(0, 500)}");
        }

        static string ReadContent(Site site, HttpResponseMessage response)
        {
        ...
        static byte[] PreventCutOff(byte[] bytes)
        {
        ...
        static CookieContainer CopyCookieContainer()
        {
        ...
        static HttpRequestMessage GenerateHttpRequestMessage(Request request, Site site)
        {
